...
func setupErrorTypes(env *runtime.Environment) {
	// Error 构造器
	env.Declare("Error", object.NewBuiltin("Error", func(args ...object.Value) object.Value {
		msg := ""
		if len(args) > 0 {
			msg = toStr(args[0])
		}
	...
	env.Declare("TypeError", object.NewBuiltin("TypeError", func(args ...object.Value) object.Value {
		msg := ""
		if len(args) > 0 {
			msg = toStr(args[0])
		}
	...
	env.Declare("RangeError", object.NewBuiltin("RangeError", func(args ...object.Value) object.Value {
		msg := ""
		if len(args) > 0 {
			msg = toStr(args[0])
		}
	...
	env.Declare("ReferenceError", object.NewBuiltin("ReferenceError", func(args ...object.Value) object.Value {
		msg := ""
		if len(args) > 0 {
			msg = toStr(args[0])
		}
	...
	env.Declare("SyntaxError", object.NewBuiltin("SyntaxError", func(args ...object.Value) object.Value {
		msg := ""
		if len(args) > 0 {
			msg = toStr(args[0])
		}
